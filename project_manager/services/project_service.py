...
from project_manager.errors.my_errors import ProjectNotPersistedError, UserNotFoundError
...
def create_project(project_dto:ProjectCreateDto, persist_funct: Callable[[ProjectModel], Optional[ProjectModel]],
                   user_exists_funct: Callable[[int],bool]) -> Result[ProjectCreatedDto, ProjectNotPersistedError]:
    '''hola'''
