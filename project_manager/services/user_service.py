...
from project_manager.mappers.user_mapper import user_create_dto_to_user_model, user_model_to_user_get_dto
from project_manager.model import UserModel


def create_user(user_dto:UserCreateDto, persist_funct: Callable[[UserModel], Optional[UserModel]]) -> Result[UserGetDto, UserNotPersistedError]:
    '''hola'''
    ...
    if user_model_persisted:
        user_created_dto: UserGetDto = user_model_to_user_get_dto(user_model)
